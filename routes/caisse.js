...
router.get('/', async (req, res) => {
    try {
        ...
        console.error('Error fetching caisse overview:', error);
        res.status(500).json({ message: 'Error fetching caisse overview' });
    }
});

// Session endpoint (alias for backward compatibility)
