...
// Settings root endpoint - returns system settings (public)
router.get('/', async (req, res) => {
    try {
        // Return default settings for now (system_settings table may not exist)
        res.json({
 ...
 *     description: Retrieve global system settings (public endpoint)
 *     responses:
 *       200:
